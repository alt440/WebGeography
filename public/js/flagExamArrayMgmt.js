...
function manageCountriesArray(){
  ...
  console.log("img/flags/"+examCountriesArray[value]+".png "+counterRightAnswers+" "+value);
  return "img/flags/"+examCountriesArray[value]+".png";
}
...
function removeSelectedCountry(index){
  ...
  if(localStorage.getItem("examArrayInit") == 1 && examCountriesArray.length == 0){
    ...
    //this will need to change for flags...
