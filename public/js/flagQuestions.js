...
function chooseSource(){
  ...
  if(choiceContinent == undefined || choiceContinent == 0){
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countries[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countries[value]+".png";
    }
  ...
  //Africa
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countriesAfrica[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countriesAfrica[value]+".png";
    }
  }
  //Asia
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countriesAsia[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countriesAsia[value]+".png";
    }
  }
  //Europe
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countriesEurope[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countriesEurope[value]+".png";
    }
  }
  //North America
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countriesNorthAmerica[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countriesNorthAmerica[value]+".png";
    }
  }
  //Oceania
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countriesOceania[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countriesOceania[value]+".png";
    }
  }
  //South America
    ...
    if(choiceTypeGame==1){
      ...
      console.log("img/flags/"+countriesSouthAmerica[value]+".png"+counterRightAnswers+" "+value);
      return "img/flags/"+countriesSouthAmerica[value]+".png";
    }
  }
...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    ...
    //answer given from the button answer in practice mode
    $('#answerText').hide();
